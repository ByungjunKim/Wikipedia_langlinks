...
bash build-corpus.sh en kowiki-20200301  > ko-en.txt
# bash build-corpus.sh ko enwiki-20200301  > en-ko.txt
...
python create_index.py --output_folder="output" --input_path="ko-en.txt" --from_lang_to_lang="ko---en" --verbose=2
